-- Database Fix Script for MathSpeedup 2.0 Phase 1/2/3 - Version 4
-- Fixes: Changed standalone PERFORM statements back to SELECT (PERFORM is only valid inside PL/pgSQL)
...
-- Done.
COMMENT ON SCHEMA public IS 'MathSpeedup 2.0 fixed state (v4)';